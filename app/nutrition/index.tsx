import {View, Text, Image, StyleSheet, Pressable, VirtualizedList, ScrollView, Share} from "react-native"
    ...
    const {data, isFetching, error} = useQuery({
        ...
        queryFn: async () => {
            try{
                ...
                const response = await api.post<ResponseData>("http://192.168.0.104:3003/create", {
                    name: user.name,
                    age: user.age,
                    gender: user.gender,
                    height:  user.height,
